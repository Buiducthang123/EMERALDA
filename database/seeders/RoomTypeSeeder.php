...
class RoomTypeSeeder extends Seeder
{
    ...
    public function run(): void
    {
        RoomType::create([
            ...
            'intro_description'=>'Rộng rãi hơn, góc nhìn đẹp hơn với phòng Premium Balcony',
            'amenities' => [],
            'max_people' => 3,
            'price' => 100000,
            'area' => 30,
        ...
        RoomType::create([
            ...
            'intro_description'=>'Trải nghiệm phòng Deluxe rộng rãi, ấm cúng và đầy đủ tiện nghi',
            'amenities' => [],
            'max_people' => 5,
            'price' => 200000,
            'area' => 50,
        ...
        RoomType::create([
            ...
            'intro_description'=>'Phòng Grand Premiumvới không gian thoáng đãng và ban công tuyệt đẹp!',
            'amenities' => [],
            'max_people' => 5,
            'price' => 300000,
            'area' => 42,
